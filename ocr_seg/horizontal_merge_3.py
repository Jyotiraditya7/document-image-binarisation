...
# ---- Merge horizontally overlapping OR nearly touching ----
merged_boxes = []
line_tolerance = 30   # vertical closeness for "same line"
gap_tolerance = 5     # small horizontal gap allowed for merge
...
for cnt in contours:
    ...
    for j, box2 in enumerate(merged_boxes):
        ...
        if abs(cy1 - cy2) < line_tolerance:
            # horizontally overlapping OR small gap
